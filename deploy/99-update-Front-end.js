...
const FRONT_END_ADDRESS_FILE = "../next-app/constants/contractAddress.json";
const FRONT_END_ABI_FILE = "../next-app/constants/abi.json";

module.exports = async function(){

    if(process.env.FRONT_END_CHANGED== true){
